            ...
            <div className="container mx-auto mt-4 flex flex-row">
                ...
                {data && data.data.articles.map(content => (
                    <div className="max-w-sm rounded overflow-hidden shadow-lg px-4 py-2 m-2">
                        <img className="w-full" src={data && content.heroMedia.content.image} alt="Sunset in the mountains"></img>
                        <div className="px-6 py-4">
                            <a href={data && '/article/' + content.slug} className="font-bold text-xl mb-2">{data && content.heroMedia.title}</a>
